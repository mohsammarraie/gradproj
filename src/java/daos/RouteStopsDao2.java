 ...
 * @author MOH
 */
public class RouteStopsDao2 extends ConnectionDao{
    
    
     public ArrayList<RouteStops2> buildRouteStops(int routeId) throws Exception {
        ArrayList<RouteStops2> list = new ArrayList<>();
...
//                           + " BUSES.STOPS.STOP_ID = BUSES.ROUTE_STOPS.STOP_ID ORDER BY STOP_ORDER";                        
      ...
      private RouteStops2 populateRouteStops(ResultSet rs) throws SQLException {
...
//    }
    ...
    public void deleteRouteStop(int stopId, int routeId) throws Exception {
        ...
        public RouteStops2 getRouteStops(int stopId) throws Exception {
        try {   
            RouteStops2 stops = null;
            Connection conn = getConnection();
